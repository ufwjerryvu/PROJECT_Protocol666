...
Player FileHandling::loadTestRagdoll(SDL_Renderer* renderer, UserEvent user_actions) {
	...
	*/
	...
	vector<SDL_Texture*> anm_frames_jumping;
	...
	anm_frames_jumping.push_back(loadTexture(renderer, "Assets/Sprite/Character/Player/Ragdoll/jump1.png"));

	anm_frames_falling.push_back(loadTexture(renderer, "Assets/Sprite/Character/Player/Ragdoll/fall1.png"));

	Animation animation = { anm_frames_idle, anm_frames_running,  anm_frames_jumping, anm_frames_falling,
		INITIAL_FRAME, INITIAL_FRAME, INITIAL_FRAME, INITIAL_FRAME};
