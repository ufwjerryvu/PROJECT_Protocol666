...
public:
	...
	*/
	AboutPage();
	AboutPage(UserEvent user_actions, int screen_width, int screen_height,
		SDL_Renderer* renderer);

	/*
	SECTION 2: ASSET LOADING
	*/
	bool loadAllAboutPageAssets();
...
*/
AboutPage::AboutPage() : Navigation() {
	/*
	NOTE:
...
AboutPage::AboutPage(UserEvent user_actions, int screen_width, int screen_height,
	...
	*/
	...
	this->loadAllAboutPageAssets();
}

/*
SECTION 2: ASSET LOADING
*/
bool AboutPage::loadAllAboutPageAssets() {
	bool success = true;
