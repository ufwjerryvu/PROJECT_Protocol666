...
bool Game::loadAllAssets() {
	...
	this->melee_goon = file_io.loadMeleeGoon(this->renderer, this->level_config_paths[this->current_level]);
	...
	*/
	...
	this->melee_goon.loadLevelWidth(this->level_width);
	this->melee_goon.loadLevelHeight(this->level_height);
...
void Game::updateRenderCoordinates() {
	...
	*/
	...
	this->melee_goon.setRenderCoordinates(this->camera.x, this->camera.y);
...
void Game::updateCollisions() {
	...
	*/
	...
	this->melee_goon.setCollision(Collision());
	...
	*/
	...
	this->melee_goon.collide(this->platforms);
	this->melee_goon.collide(this->grounds);
...
void Game::update() {
	...
	*/
	...
	this->melee_goon.update();
	this->melee_goon.detectPlayer(this->player, grounds, platforms);
}
...
void Game::render() {
	...
	*/
	...
	this->melee_goon.render(this->renderer);
